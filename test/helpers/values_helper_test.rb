...
class ApplicationHelperTest < ActionView::TestCase
  ...
  test "unique_links_for_scope should not mutilate urls" do
    text_containing_links = "<a href='http://ipib.ci.moez.fraunhofer.de/companies/richter-werdermann-gerbaulet-hofmann'>richter-werdermann-gerbaulet-hofmann</a> failed Company-dq-test_CO-005.<br>"
